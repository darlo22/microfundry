...
- June 18, 2025. Reduced logo size by 1.5X across all platform components: updated FundryLogo component default size from h-60 to h-40, reduced founder dashboard page logos from h-36 to h-24, updated payment withdrawal page logo from h-24 to h-16 for consistent, appropriately-sized branding throughout the application
